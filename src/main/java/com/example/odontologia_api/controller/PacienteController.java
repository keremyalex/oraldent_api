...
public class PacienteController {
    ...
    @Operation(summary = "Subir la foto de un paciente a Cloudinary")
    public PacienteResponse actualizarFoto(@PathVariable Long id, @RequestPart("archivo") MultipartFile archivo) {
        return pacienteService.actualizarFoto(id, archivo);
    }
