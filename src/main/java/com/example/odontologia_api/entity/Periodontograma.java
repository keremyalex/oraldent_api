...
public class Periodontograma {
    ...
    @OneToMany(mappedBy = "periodontograma", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<PeriodontogramaDiente> dientes = new ArrayList<>();
    ...
    public void addDiente(PeriodontogramaDiente diente) {
        dientes.add(diente);
        diente.setPeriodontograma(this);
    }
    ...
    public List<PeriodontogramaDiente> getDientes() { return dientes; }
}
